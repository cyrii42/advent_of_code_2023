...
def main():
    ...
    print(f"Part One Answer:  {sum([history.next_value for history in dataset])}") # Part One answer is 2038472161
    print(f"Part Two Answer:  {sum([history.previous_value for history in dataset])}") # Part Two answer is 1091
