...
class Card():
    def __init__(self, card_num: str, winning_nums: list, held_nums: list):
        ...
        self.reward_cards = self.pull_reward_cards() if self.num_of_winning_numbers > 0 else []
    ...
    def pull_reward_cards(self) -> list:
        output_list = []
        for reward_card_num in self.reward_card_nums:
            ...
...
class CardPile():
    ...
    def pull_all_reward_cards(self) -> list[Card]:
        ...
...
def main():
    card_list = ingest_input_string()

    # part_one_answer = find_part_one_answer(card_list)  ## part #1 answer is:  18619
    # print(f"GRAND TOTAL:  {part_one_answer}")
...
def ingest_input_string() -> list[Card]:
